...
\cite{richardAutoGPTHeartOpensource2023}

some text!

\cite{maiOpportunitiesChallengesFoundation2023}

\cite{yaoReActSynergizingReasoning2023}

writing some stuff  pls be quick

\cite{xuRetrievalMeetsLong2023}

pls be faster

\cite{robertsGPT4GEOHowLanguage2023}

testing what happens if I only write text
\cite{yaoReActSynergizingReasoning2023}

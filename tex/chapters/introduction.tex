...
\begin{itemize}
    ...
    \item \Autochapterref{cha:discussion} discusses some of the finding of the experiments, and other considerations when developing an \acrshort{acr:llm}-based \acrshort{acr:gis} agent.
    \item \Autochapterref{cha:conclusion} sums up the work and points to ways it can be improved or extended in the future.
\end{itemize}

...
\begin{itemize}
    ...
    \item \Autochapterref{cha:discussion-and-conclusion} discusses some of the finding of the experiments, provide considerations when developing an \acrshort{acr:llm}-based \acrshort{acr:gis} agent, and concludes the project report.
\end{itemize}

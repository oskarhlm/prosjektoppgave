...
\makeglossaries
\loadglsentries[main]{frontmatter/glossary}
...
\newcommand{\thesisSubtitle}{An Investigation into Using Large Language Models to Make GIS Analysis Simpler, Faster, and More Accessible}
\newcommand{\thesisType}{Master's Thesis in Computer Science and Geomatics}
\newcommand{\supervisor}{Supervisor: Hongchao Fan}

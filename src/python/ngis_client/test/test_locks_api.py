...
from swagger_client.api.locks_api import LocksApi  # noqa: E501
...
class TestLocksApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = LocksApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_delete_dataset_locks(self):
        """Test case for delete_dataset_locks
    ...
    def test_get_dataset_locks(self):
        """Test case for get_dataset_locks

...
class TestFeaturesApi(unittest.TestCase):
    ...
    def test_get_dataset_feature(self):
        """Test case for get_dataset_feature

        Hent ut en bestemt feature fra et dataset  # noqa: E501
        """
        pass

    def test_get_dataset_feature_attributes(self):
        """Test case for get_dataset_feature_attributes
    ...
    def test_get_dataset_features(self):
        """Test case for get_dataset_features

        Hent ut features fra et dataset  # noqa: E501
        """
        pass

    def test_update_dataset_feature_attributes(self):
        """Test case for update_dataset_feature_attributes

        Endre egenskapene til en bestemt feature i et dataset  # noqa: E501
        """
        pass

    def test_update_dataset_features(self):
        """Test case for update_dataset_features

...
namespace IO.Swagger.Test
{
    ...
    public class LocksApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOfType' LocksApi
            //Assert.IsInstanceOfType(typeof(LocksApi), instance, "instance is a LocksApi");
        }

        /// <summary>
        /// Test DeleteDatasetLocks
        /// </summary>
        [Test]
        public void DeleteDatasetLocksTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string xClientProductVersion = null;
            //Guid? datasetId = null;
            //string lockingType = null;
            //instance.DeleteDatasetLocks(xClientProductVersion, datasetId, lockingType);
            
        }
        /// <summary>
        /// Test GetDatasetLocks
        /// </summary>
        [Test]
        public void GetDatasetLocksTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string xClientProductVersion = null;
            //Guid? datasetId = null;
            ...
            //var response = instance.GetDatasetLocks(xClientProductVersion, datasetId, lockingType, bbox, crsEPSG, normalizedForVisualization);
            //Assert.IsInstanceOf<Locks> (response, "response is Locks");
        }
    }

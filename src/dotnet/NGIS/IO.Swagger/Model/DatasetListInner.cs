...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DatasetListInner :  IEquatable<DatasetListInner>, IValidatableObject
    {
        /// <summary>
        /// Defines Access
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DatasetListInner" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        /// <param name="access">access.</param>
        public DatasetListInner(Guid? id = default(Guid?), string name = default(string), AccessEnum? access = default(AccessEnum?))
        {
            this.Id = id;
            this.Name = name;
            this.Access = access;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DatasetListInner {\n");
        ...
        {
            return this.Equals(input as DatasetListInner);
        }

        /// <summary>
        /// Returns true if DatasetListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of DatasetListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DatasetListInner input)
        {
            if (input == null)
                return false;

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Locks : List<LocksInner>,  IEquatable<Locks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Locks" /> class.
        /// </summary>
        public Locks() : base()
        {
        }
        ...
        {
            return this.Equals(input as Locks);
        }

        /// <summary>
        /// Returns true if Locks instances are equal
        /// </summary>
        /// <param name="input">Instance of Locks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Locks input)
        {
            if (input == null)
                return false;

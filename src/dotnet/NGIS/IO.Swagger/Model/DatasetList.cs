...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DatasetList : List<DatasetListInner>,  IEquatable<DatasetList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DatasetList" /> class.
        /// </summary>
        public DatasetList() : base()
        {
        }
        ...
        {
            return this.Equals(input as DatasetList);
        }

        /// <summary>
        /// Returns true if DatasetList instances are equal
        /// </summary>
        /// <param name="input">Instance of DatasetList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DatasetList input)
        {
            if (input == null)
                return false;

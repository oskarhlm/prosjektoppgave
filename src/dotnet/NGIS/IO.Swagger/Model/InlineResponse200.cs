...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="featuresCreated">featuresCreated.</param>
        /// <param name="featuresReplaced">featuresReplaced.</param>
        /// <param name="featuresErased">featuresErased.</param>
        public InlineResponse200(int? featuresCreated = default(int?), int? featuresReplaced = default(int?), int? featuresErased = default(int?))
        {
            this.FeaturesCreated = featuresCreated;
            this.FeaturesReplaced = featuresReplaced;
            this.FeaturesErased = featuresErased;
        }
        
        /// <summary>
        /// Gets or Sets FeaturesCreated
        /// </summary>
        [DataMember(Name="features_created", EmitDefaultValue=false)]
        public int? FeaturesCreated { get; set; }

        /// <summary>
        /// Gets or Sets FeaturesReplaced
        /// </summary>
        [DataMember(Name="features_replaced", EmitDefaultValue=false)]
        public int? FeaturesReplaced { get; set; }

        /// <summary>
        /// Gets or Sets FeaturesErased
        /// </summary>
        [DataMember(Name="features_erased", EmitDefaultValue=false)]
        public int? FeaturesErased { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FeaturesCreated: ").Append(FeaturesCreated).Append("\n");
            sb.Append("  FeaturesReplaced: ").Append(FeaturesReplaced).Append("\n");
            sb.Append("  FeaturesErased: ").Append(FeaturesErased).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse200 input)
        {
            ...
            return 
                (
                    this.FeaturesCreated == input.FeaturesCreated ||
                    (this.FeaturesCreated != null &&
                    this.FeaturesCreated.Equals(input.FeaturesCreated))
                ) && 
                (
                    this.FeaturesReplaced == input.FeaturesReplaced ||
                    (this.FeaturesReplaced != null &&
                    this.FeaturesReplaced.Equals(input.FeaturesReplaced))
                ) && 
                (
                    this.FeaturesErased == input.FeaturesErased ||
                    (this.FeaturesErased != null &&
                    this.FeaturesErased.Equals(input.FeaturesErased))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.FeaturesCreated != null)
                    hashCode = hashCode * 59 + this.FeaturesCreated.GetHashCode();
                if (this.FeaturesReplaced != null)
                    hashCode = hashCode * 59 + this.FeaturesReplaced.GetHashCode();
                if (this.FeaturesErased != null)
                    hashCode = hashCode * 59 + this.FeaturesErased.GetHashCode();
                return hashCode;
            }
        }
